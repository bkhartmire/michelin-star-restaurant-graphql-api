const restaurants = [
  ...
  const cities = [
    ...
    { name: "Chew Magna  BS TQ", country_name: "United Kingdom" },
    { name: "Penarth  CF AU", country_name: "United Kingdom" },
  ...
  for (const restaurant of restaurants) {
      if (!cityNames.includes(restaurant.city_name)) {
